  ...
  apply(routeHandler) {
    ...
    routeHandler.hooks.initRoutes.tapPromise('AppRoutes', async () => {
      ...
      routeHandler.setPwaSchema({
        ...
        lang: 'en-US',
        orientation: 'any',
        start_url: '/examples/semantic-ui',
        background_color: '#111',
        theme_color: '#111',
        display: 'standalone',
        description: 'Semantic-UI implementation using ReactPWA',
        icons: [
          {
            src: ShareImg72,
            sizes: '72x72',
      ...
      routeHandler.getDefaultSeoSchema = () => ({
        ...
        meta: [
          ...
          {
            name: 'description',
            content: 'Semantic-UI implementation using ReactPWA',
          },
          {
            name: 'theme-color',
            content: '#111',
